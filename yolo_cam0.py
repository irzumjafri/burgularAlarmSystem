...
cam_show = True
string ="live_cam"
video_out = cv2.VideoWriter(string+"1.avi",cv2.VideoWriter_fourcc('M','P','4','2'), 10, (640,480))
...
if args.mode == "online":
    ...
    video_capture_0 = cv2.VideoCapture("testing_video_0.avi")
